...
new hobs.TestSuite("We.Train Tests", {path:"/apps/training/tests/SampleTests.js", register: true})
    ...
    .addTestCase(new hobs.TestCase("Hero component on en.html")
        .navigateTo("/content/pluralsight-train/en.html")
        .asserts.location("/content/pluralsight-train/en.html", true)
        .asserts.visible(".hero-image", true)
    )

    .addTestCase(new hobs.TestCase("Hero component on fr.html")
        .navigateTo("/content/pluralsight-train/fr.html")
        .asserts.location("/content/pluralsight-train/fr.html", true)
        .asserts.visible(".hero-image", true)
    )
    ...
    .addTestCase(new hobs.TestCase("Print Selector inserted on en.html")
        .navigateTo("/content/pluralsight-train/en.html")
        .asserts.location("/content/pluralsight-train/en.html", true)
        .asserts.exists("form.page__print[action='/content/pluralsight-train/en.print']",true)
    );
